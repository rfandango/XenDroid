...
object SettingDescriptions {
    val byName: Map<String, String> = mapOf(
        ...
        "headless" to "Suppresses in-game system dialogs, answering prompts automatically with defaults",
        ...
        "internal_display_resolution" to "Resolution the console reports to games; supported titles render at it, not guaranteed for all",
