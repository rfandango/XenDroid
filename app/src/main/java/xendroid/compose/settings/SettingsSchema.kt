...
object SettingsSchema {
    ...
    val categories: List<SettingsCategory> = listOf(
        ...
        SettingsCategory("Vulkan", listOf(
            ...
            // Rate trades detail for shading time; scope and cutoff pick which
            // draws pay it, keeping UI and text at the native rate.
            l("Vulkan", "vulkan_vrs_blended", "Coarse shading rate", "0",
                "0" to "Off (native rate)", "1" to "2x1 (half)",
                "2" to "2x2 (quarter)", "3" to "4x2 (eighth)",
                "4" to "4x4 (sixteenth)"),
            l("Vulkan", "vulkan_vrs_scope", "Coarse shading applies to", "0",
                "0" to "Every draw", "1" to "World geometry",
                "2" to "Blended draws", "3" to "Blended world geometry"),
            l("Vulkan", "vulkan_vrs_min_shader_dwords", "Coarse shading shader cutoff", "48",
                "0" to "Off (no cutoff)", "24" to "Low (8 instructions)",
                "48" to "Medium (16 instructions)", "96" to "High (32 instructions)",
                "192" to "Very high (64 instructions)"),
